...
module.exports = {
  ...
  title: "Map-gis",
  description: '为简化GIS开发而生',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'gis,map,内网,地图' }],
  ...
  themeConfig: {
    ...
    repo: 'https://pan.baidu.com/s/1h12upnBMIux5yhYxeorF3w?pwd=7yru', // 导航栏右侧生成Github链接
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:87766867@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://gitee.com/bdj'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'Map gis | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
